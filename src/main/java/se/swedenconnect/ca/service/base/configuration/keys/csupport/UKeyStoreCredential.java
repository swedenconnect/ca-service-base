 ...
 */
public class UKeyStoreCredential extends AbstractReloadablePkiCredential implements UPkiCredential {

  /** Logger **/
  private static final Logger log = LoggerFactory.getLogger(se.swedenconnect.security.credential.KeyStoreCredential.class);
   ...
   */
  public UKeyStoreCredential(@Nonnull final KeyStore keyStore, @Nonnull final String alias,
