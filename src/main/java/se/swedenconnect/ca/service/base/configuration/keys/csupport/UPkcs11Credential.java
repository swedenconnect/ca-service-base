...
package se.swedenconnect.ca.service.base.configuration.keys.csupport;
...
import se.swedenconnect.security.credential.pkcs11.Pkcs11CertificatesAccessor;
...
import se.swedenconnect.security.credential.pkcs11.Pkcs11PrivateKeyAccessor;
 ...
 */
@Slf4j
public class UPkcs11Credential extends AbstractReloadablePkiCredential implements UPkiCredential {
   ...
   */
  public UPkcs11Credential(@Nonnull final Pkcs11Configuration configuration, @Nonnull final String alias,
  ...
  public UPkcs11Credential(@Nonnull final Pkcs11Configuration configuration, @Nonnull final String alias,
    ...
    this(configuration, alias, pin, privateKeyAccessor, new UPkcs11Credential.StaticCertificateAccessor(certificates));
  }
  ...
  @Override
  public void setCertificateChain(final List<X509Certificate> chain) {
