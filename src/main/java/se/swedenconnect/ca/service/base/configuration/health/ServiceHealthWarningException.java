...
public class ServiceHealthWarningException extends RuntimeException{
  ...
  /**
   * Constructs a new ServiceHealthWarningException with {@code null} as its
  ...
  /**
   * Constructs a new ServiceHealthWarningException with the specified detail message.
  ...
  /**
   * Constructs a new ServiceHealthWarningException with the specified detail message
   * and health report details.
   * The cause is not initialized, and may subsequently be initialized by a
   * call to {@link #initCause}.
   *
   * @param message the detail message. The detail message is saved for
   * @param details details to be provided to the health report
   * later retrieval by the {@link #getMessage()} method.
   */
  ...
  /**
   * Constructs a new ServiceHealthWarningException with the specified detail message and
  ...
  /**
   * Constructs a new ServiceHealthWarningException with the specified cause and a
  ...
  /**
   * Constructs a new ServiceHealthWarningException with the specified detail
   ...
   * @since 1.7
   */
  public ServiceHealthWarningException(String message, Throwable cause, boolean enableSuppression,
